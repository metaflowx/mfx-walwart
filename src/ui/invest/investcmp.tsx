...
const Investcmp = () => {
    ...
    return (
        <>
            <Box>
                <Box>
                    <Typography variant="h5" fontWeight={700} color="#0071CE">Member Center</Typography>
                </Box>
                <Box sx={{
                    ...
                    <Grid2 container spacing={2}>
                        <Grid2 size={{ lg: 6, md: 6, sm: 12, xs: 12 }}>
                            <Box sx={{
                                ...
                                <Typography color="#0071CE" variant="h6" fontWeight={700}>0.00</Typography>
                        ...
                        <Grid2 size={{ lg: 6, md: 6, sm: 12, xs: 12 }}>
                            <Box sx={{
                                ...
                                <Typography color="#fff" variant="h6" fontWeight={700}>0.00</Typography>
                ...
                <Box textAlign={'center'} >
                    <Typography mb={2} mt={4} color="#0071CE" variant="h6">Reset Countdown</Typography>
