          ...
          <TableBody>
            {loading ?(
              ...
              <TableRow key={item._id}>
                ...
                <TableCell>
                  <Typography color="#000">${Number(item?.stats?.totalSumOfInvestment).toFixed(4) || 0}</Typography>
                </TableCell>
                <TableCell>
                  <Typography color="#000">${Number(Number(item?.stats?.totalSumOfInvestmentEarnings)+Number(item?.totalCommissionEarning)).toFixed(4) || 0}</Typography>
                </TableCell>
