  ...
  return (
    <div>
      ...
      <div className="pt-3 pb-6">
        <button className="bg-[#0071CE] border border-[#0071CE] rounded-[51px] text-white w-[174px] text-[20px] font-[700] h-[70px] ">
          In progress
        </button>
        <button className="pl-6 rounded-[51px] text-[20px] text-[#0071CE] font-[700] ">
          Completed
        </button>
      </div>
